...
The following settings can be used during a Biome service's lifecycle. This means that you can use these settings in any of the plan hooks, such as `init`, or `run`, and also in any templatized configuration file for your application or service.
...
| version | string | Version of the Biome Supervisor, e.g., `0.54.0/20180221023448` |
...
| origin | string | The origin of the Biome package |
| name | string | The name of the Biome package |
| version | string | The version of the Biome package |
| release | string | The release of the Biome package |
...
| svc_path | string | The root location of the source files for the Biome service, e.g., `/hab/svc/redis`. |
| svc_config_path | string | The location of any templated configuration files for the Biome service, e.g., `/hab/svc/redis/config`. |
| svc_data_path | string | The location of any data files for the Biome service, e.g., `/hab/svc/redis/data`. |
| svc_files_path | string | The location of any gossiped configuration files for the Biome service, e.g., `/hab/svc/redis/files`. |
| svc_static_path | string | The location of any static content for the Biome service, e.g., `/hab/svc/redis/static`. |
| svc_var_path | string | The location of any variable state data for the Biome service, e.g., `/hab/svc/redis/var`. |
| svc_pid_file | string | The location of the Biome service pid file, e.g., `/hab/svc/redis/PID`. |
| svc_run | string | The location of the rendered run hook for the Biome service, e.g., `/hab/svc/redis/run`. |
...
A Biome package identifier, split apart into its constituent components
