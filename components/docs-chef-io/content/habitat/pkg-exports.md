...
Additionally, the Kubernetes Biome operator is automatically added to the Helm chart as a dependency and hence installed automatically as part of the Biome Helm chart.
